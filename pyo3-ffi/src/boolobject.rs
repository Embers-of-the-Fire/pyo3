...
#[inline]
pub unsafe fn PyBool_Check(op: *mut PyObject) -> ffi::c_int {
    (Py_TYPE(op) == addr_of_mut!(PyBool_Type)) as ffi::c_int
}
...
#[inline]
pub unsafe fn Py_IsTrue(x: *mut PyObject) -> ffi::c_int {
    Py_Is(x, Py_True())
}

#[inline]
pub unsafe fn Py_IsFalse(x: *mut PyObject) -> ffi::c_int {
    Py_Is(x, Py_False())
}
...
extern "C" {
    ...
    pub fn PyBool_FromLong(arg1: ffi::c_long) -> *mut PyObject;
}
