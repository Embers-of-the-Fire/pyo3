...
extern "C" {
    ...
    pub fn PyObject_Malloc(size: size_t) -> *mut ffi::c_void;
    #[cfg_attr(PyPy, link_name = "PyPyObject_Calloc")]
    pub fn PyObject_Calloc(nelem: size_t, elsize: size_t) -> *mut ffi::c_void;
    #[cfg_attr(PyPy, link_name = "PyPyObject_Realloc")]
    pub fn PyObject_Realloc(ptr: *mut ffi::c_void, new_size: size_t) -> *mut ffi::c_void;
    #[cfg_attr(PyPy, link_name = "PyPyObject_Free")]
    pub fn PyObject_Free(ptr: *mut ffi::c_void);
...
extern "C" {
    ...
    pub fn PyGC_Enable() -> ffi::c_int;

    #[cfg(Py_3_10)]
    #[cfg_attr(PyPy, link_name = "PyPyGC_Disable")]
    pub fn PyGC_Disable() -> ffi::c_int;

    #[cfg(Py_3_10)]
    #[cfg_attr(PyPy, link_name = "PyPyGC_IsEnabled")]
    pub fn PyGC_IsEnabled() -> ffi::c_int;
}

#[inline]
pub unsafe fn PyType_IS_GC(t: *mut PyTypeObject) -> ffi::c_int {
...
extern "C" {
    ...
    #[cfg(not(PyPy))]
    pub fn PyObject_GC_Track(arg1: *mut ffi::c_void);

    #[cfg(not(PyPy))]
    pub fn PyObject_GC_UnTrack(arg1: *mut ffi::c_void);

    #[cfg_attr(PyPy, link_name = "PyPyObject_GC_Del")]
    pub fn PyObject_GC_Del(arg1: *mut ffi::c_void);
}
...
extern "C" {
    ...
    pub fn PyObject_GC_IsTracked(arg1: *mut PyObject) -> ffi::c_int;
    #[cfg(any(all(Py_3_9, not(PyPy)), Py_3_10))] // added in 3.9, or 3.10 on PyPy
    #[cfg_attr(PyPy, link_name = "PyPyObject_GC_IsFinalized")]
    pub fn PyObject_GC_IsFinalized(arg1: *mut PyObject) -> ffi::c_int;
}
