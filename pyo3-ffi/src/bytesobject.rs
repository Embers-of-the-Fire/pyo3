...
#[inline]
pub unsafe fn PyBytes_Check(op: *mut PyObject) -> ffi::c_int {
    PyType_FastSubclass(Py_TYPE(op), Py_TPFLAGS_BYTES_SUBCLASS)
}

#[inline]
pub unsafe fn PyBytes_CheckExact(op: *mut PyObject) -> ffi::c_int {
    (Py_TYPE(op) == addr_of_mut!(PyBytes_Type)) as ffi::c_int
}

extern "C" {
    #[cfg_attr(PyPy, link_name = "PyPyBytes_FromStringAndSize")]
    pub fn PyBytes_FromStringAndSize(arg1: *const ffi::c_char, arg2: Py_ssize_t) -> *mut PyObject;
    pub fn PyBytes_FromString(arg1: *const ffi::c_char) -> *mut PyObject;
    ...
    //pub fn PyBytes_FromFormatV(arg1: *const ffi::c_char, arg2: va_list)
    // -> *mut PyObject;
    #[cfg_attr(PyPy, link_name = "PyPyBytes_FromFormat")]
    pub fn PyBytes_FromFormat(arg1: *const ffi::c_char, ...) -> *mut PyObject;
    ...
    pub fn PyBytes_AsString(arg1: *mut PyObject) -> *mut ffi::c_char;
    pub fn PyBytes_Repr(arg1: *mut PyObject, arg2: ffi::c_int) -> *mut PyObject;
