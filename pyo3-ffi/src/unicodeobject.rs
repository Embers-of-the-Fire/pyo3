...
extern "C" {
    ...
    pub fn PyUnicode_Check(op: *mut PyObject) -> ffi::c_int;

    #[cfg(PyPy)]
    #[link_name = "PyPyUnicode_CheckExact"]
    pub fn PyUnicode_CheckExact(op: *mut PyObject) -> ffi::c_int;
}

#[inline]
#[cfg(not(PyPy))]
pub unsafe fn PyUnicode_Check(op: *mut PyObject) -> ffi::c_int {
    PyType_FastSubclass(Py_TYPE(op), Py_TPFLAGS_UNICODE_SUBCLASS)
}

#[inline]
#[cfg(not(PyPy))]
pub unsafe fn PyUnicode_CheckExact(op: *mut PyObject) -> ffi::c_int {
    (Py_TYPE(op) == addr_of_mut!(PyUnicode_Type)) as ffi::c_int
}
...
extern "C" {
    ...
    pub fn PyUnicode_FromStringAndSize(u: *const ffi::c_char, size: Py_ssize_t) -> *mut PyObject;
    pub fn PyUnicode_FromString(u: *const ffi::c_char) -> *mut PyObject;
    ...
    // pub fn PyUnicode_FromFormatV(format: *const ffi::c_char, vargs: va_list) -> *mut PyObject;
    #[cfg_attr(PyPy, link_name = "PyPyUnicode_FromFormat")]
    pub fn PyUnicode_FromFormat(format: *const ffi::c_char, ...) -> *mut PyObject;
    ...
    pub fn PyUnicode_InternFromString(u: *const ffi::c_char) -> *mut PyObject;
    ...
    pub fn PyUnicode_FromOrdinal(ordinal: ffi::c_int) -> *mut PyObject;
    pub fn PyUnicode_ClearFreeList() -> ffi::c_int;
    #[cfg_attr(PyPy, link_name = "PyPyUnicode_GetDefaultEncoding")]
    pub fn PyUnicode_GetDefaultEncoding() -> *const ffi::c_char;
    ...
    pub fn PyUnicode_FSConverter(arg1: *mut PyObject, arg2: *mut ffi::c_void) -> ffi::c_int;
    #[cfg_attr(PyPy, link_name = "PyPyUnicode_FSDecoder")]
    pub fn PyUnicode_FSDecoder(arg1: *mut PyObject, arg2: *mut ffi::c_void) -> ffi::c_int;
    #[cfg_attr(PyPy, link_name = "PyPyUnicode_DecodeFSDefault")]
    pub fn PyUnicode_DecodeFSDefault(s: *const ffi::c_char) -> *mut PyObject;
    ...
    pub fn PyUnicode_Splitlines(s: *mut PyObject, keepends: ffi::c_int) -> *mut PyObject;
    ...
    pub fn PyUnicode_Compare(left: *mut PyObject, right: *mut PyObject) -> ffi::c_int;
    #[cfg_attr(PyPy, link_name = "PyPyUnicode_CompareWithASCIIString")]
    pub fn PyUnicode_CompareWithASCIIString(
        left: *mut PyObject,
        right: *const ffi::c_char,
    ) -> ffi::c_int;
    #[cfg(Py_3_13)]
    pub fn PyUnicode_EqualToUTF8(unicode: *mut PyObject, string: *const ffi::c_char) -> ffi::c_int;
    #[cfg(Py_3_13)]
    ...
    pub fn PyUnicode_Contains(container: *mut PyObject, element: *mut PyObject) -> ffi::c_int;
    pub fn PyUnicode_IsIdentifier(s: *mut PyObject) -> ffi::c_int;
}
