...
extern "C" {
    pub fn PyCodec_Register(search_function: *mut PyObject) -> ffi::c_int;
    #[cfg(Py_3_10)]
    #[cfg(not(PyPy))]
    pub fn PyCodec_Unregister(search_function: *mut PyObject) -> ffi::c_int;
    // skipped non-limited _PyCodec_Lookup from Include/codecs.h
    // skipped non-limited _PyCodec_Forget from Include/codecs.h
    pub fn PyCodec_KnownEncoding(encoding: *const ffi::c_char) -> ffi::c_int;
    ...
    pub fn PyCodec_Encoder(encoding: *const ffi::c_char) -> *mut PyObject;
    pub fn PyCodec_Decoder(encoding: *const ffi::c_char) -> *mut PyObject;
    ...
    pub fn PyCodec_RegisterError(name: *const ffi::c_char, error: *mut PyObject) -> ffi::c_int;
    pub fn PyCodec_LookupError(name: *const ffi::c_char) -> *mut PyObject;
