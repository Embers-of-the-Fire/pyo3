...
extern "C" {
    ...
    pub fn PySys_GetObject(arg1: *const ffi::c_char) -> *mut PyObject;
    #[cfg_attr(PyPy, link_name = "PyPySys_SetObject")]
    pub fn PySys_SetObject(arg1: *const ffi::c_char, arg2: *mut PyObject) -> ffi::c_int;
    ...
    pub fn PySys_SetArgv(arg1: ffi::c_int, arg2: *mut *mut wchar_t);
    #[cfg_attr(
        Py_3_11,
        deprecated(
            note = "Deprecated in Python 3.11, use `PyConfig.argv` and `PyConfig.parse_argv` instead"
    ...
    pub fn PySys_SetArgvEx(arg1: ffi::c_int, arg2: *mut *mut wchar_t, arg3: ffi::c_int);
    pub fn PySys_SetPath(arg1: *const wchar_t);

    #[cfg_attr(PyPy, link_name = "PyPySys_WriteStdout")]
    pub fn PySys_WriteStdout(format: *const ffi::c_char, ...);
    #[cfg_attr(PyPy, link_name = "PyPySys_WriteStderr")]
    pub fn PySys_WriteStderr(format: *const ffi::c_char, ...);
    pub fn PySys_FormatStdout(format: *const ffi::c_char, ...);
    pub fn PySys_FormatStderr(format: *const ffi::c_char, ...);
    ...
    #[cfg_attr(Py_3_11, deprecated(note = "Python 3.11"))]
    pub fn PySys_HasWarnOptions() -> ffi::c_int;
