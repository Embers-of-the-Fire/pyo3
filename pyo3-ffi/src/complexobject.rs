...
#[inline]
pub unsafe fn PyComplex_Check(op: *mut PyObject) -> ffi::c_int {
    PyObject_TypeCheck(op, addr_of_mut!(PyComplex_Type))
}

#[inline]
pub unsafe fn PyComplex_CheckExact(op: *mut PyObject) -> ffi::c_int {
...
extern "C" {
    ...
    pub fn PyComplex_FromDoubles(real: ffi::c_double, imag: ffi::c_double) -> *mut PyObject;

    #[cfg_attr(PyPy, link_name = "PyPyComplex_RealAsDouble")]
    pub fn PyComplex_RealAsDouble(op: *mut PyObject) -> ffi::c_double;
    #[cfg_attr(PyPy, link_name = "PyPyComplex_ImagAsDouble")]
    pub fn PyComplex_ImagAsDouble(op: *mut PyObject) -> ffi::c_double;
}
