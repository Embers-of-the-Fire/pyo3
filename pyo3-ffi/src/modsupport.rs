...
extern "C" {
    ...
    pub fn PyArg_Parse(arg1: *mut PyObject, arg2: *const ffi::c_char, ...) -> ffi::c_int;
    #[cfg_attr(PyPy, link_name = "PyPyArg_ParseTuple")]
    pub fn PyArg_ParseTuple(arg1: *mut PyObject, arg2: *const ffi::c_char, ...) -> ffi::c_int;
    #[cfg_attr(PyPy, link_name = "PyPyArg_ParseTupleAndKeywords")]
    pub fn PyArg_ParseTupleAndKeywords(
        arg1: *mut PyObject,
        arg2: *mut PyObject,
        arg3: *const ffi::c_char,
        #[cfg(not(Py_3_13))] arg4: *mut *mut ffi::c_char,
        #[cfg(Py_3_13)] arg4: *const *const ffi::c_char,
        ...
    ) -> ffi::c_int;
    ...
    pub fn PyArg_ValidateKeywordArguments(arg1: *mut PyObject) -> ffi::c_int;
    ...
    pub fn Py_BuildValue(arg1: *const ffi::c_char, ...) -> *mut PyObject;
    ...
    pub fn PyModule_SetDocString(arg1: *mut PyObject, arg2: *const ffi::c_char) -> ffi::c_int;
    pub fn PyModule_AddFunctions(arg1: *mut PyObject, arg2: *mut PyMethodDef) -> ffi::c_int;
    #[cfg_attr(PyPy, link_name = "PyPyModule_ExecDef")]
    pub fn PyModule_ExecDef(module: *mut PyObject, def: *mut PyModuleDef) -> ffi::c_int;
}
...
extern "C" {
    ...
    pub fn PyModule_Create2(module: *mut PyModuleDef, apiver: ffi::c_int) -> *mut PyObject;
}
...
#[cfg(Py_3_15)]
extern "C" {
    pub fn PyABIInfo_Check(info: *mut PyABIInfo, module_name: *const ffi::c_char) -> ffi::c_int;
}
