...
extern "C" {
    ...
    pub fn PyParser_ASTFromFile(
        fp: *mut FILE,
        filename: *const ffi::c_char,
        enc: *const ffi::c_char,
        start: ffi::c_int,
        ps1: *const ffi::c_char,
        ps2: *const ffi::c_char,
        flags: *mut PyCompilerFlags,
        errcode: *mut ffi::c_int,
        arena: *mut PyArena,
    ) -> *mut _mod;
    #[cfg(not(any(PyPy, GraalPy, Py_3_10)))]
...
extern "C" {
    ...
    #[cfg(not(any(PyPy, GraalPy)))]
    pub fn PyRun_AnyFile(fp: *mut FILE, name: *const ffi::c_char) -> ffi::c_int;
    #[cfg(not(any(PyPy, GraalPy)))]
    ...
    pub fn PyRun_SimpleString(s: *const ffi::c_char) -> ffi::c_int;
    #[cfg(not(any(PyPy, GraalPy)))]
    pub fn PyRun_SimpleFile(f: *mut FILE, p: *const ffi::c_char) -> ffi::c_int;
    #[cfg(not(any(PyPy, GraalPy)))]
    pub fn PyRun_SimpleFileEx(f: *mut FILE, p: *const ffi::c_char, c: ffi::c_int) -> ffi::c_int;
    #[cfg(not(any(PyPy, GraalPy)))]
    pub fn PyRun_InteractiveOne(f: *mut FILE, p: *const ffi::c_char) -> ffi::c_int;
    #[cfg(not(any(PyPy, GraalPy)))]
    pub fn PyRun_InteractiveLoop(f: *mut FILE, p: *const ffi::c_char) -> ffi::c_int;
