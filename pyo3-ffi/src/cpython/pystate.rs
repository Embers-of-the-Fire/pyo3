...
pub const PyTrace_CALL: ffi::c_int = 0;
pub const PyTrace_EXCEPTION: ffi::c_int = 1;
pub const PyTrace_LINE: ffi::c_int = 2;
pub const PyTrace_RETURN: ffi::c_int = 3;
pub const PyTrace_C_CALL: ffi::c_int = 4;
pub const PyTrace_C_EXCEPTION: ffi::c_int = 5;
pub const PyTrace_C_RETURN: ffi::c_int = 6;
pub const PyTrace_OPCODE: ffi::c_int = 7;
...
extern "C" {
    ...
    pub fn PyGILState_Check() -> ffi::c_int;
