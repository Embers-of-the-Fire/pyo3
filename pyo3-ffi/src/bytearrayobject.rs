...
pub struct PyByteArrayObject {
    ...
    pub ob_bytes: *mut ffi::c_char,
    pub ob_start: *mut ffi::c_char,
    #[cfg(Py_3_9)]
    pub ob_exports: Py_ssize_t,
    #[cfg(not(Py_3_9))]
    pub ob_exports: ffi::c_int,
    #[cfg(Py_3_15)]
...
#[inline]
pub unsafe fn PyByteArray_Check(op: *mut PyObject) -> ffi::c_int {
    PyObject_TypeCheck(op, addr_of_mut!(PyByteArray_Type))
}

#[inline]
pub unsafe fn PyByteArray_CheckExact(op: *mut PyObject) -> ffi::c_int {
    (Py_TYPE(op) == addr_of_mut!(PyByteArray_Type)) as ffi::c_int
}
...
extern "C" {
    ...
    pub fn PyByteArray_AsString(bytearray: *mut PyObject) -> *mut ffi::c_char;
    #[cfg_attr(PyPy, link_name = "PyPyByteArray_Resize")]
    pub fn PyByteArray_Resize(bytearray: *mut PyObject, len: Py_ssize_t) -> ffi::c_int;
}
